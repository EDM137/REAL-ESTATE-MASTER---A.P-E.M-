    ...
    const handleGenerateAndPlay = async () => {
        ...
        try {
            const response = await ai.models.generateContent({
                ...
                contents: { 
                    parts: [{ 
                        text: `[REFINED VOICE GUIDANCE: You are a well-spoken Caucasian woman. Use proper enunciation and natural pronunciation. Incorporate subtle, realistic breaths between sentences and phrases. Your tone should be conversational, warm, and highly expressive, adjusting your emotional inflection naturally to the context of this text.] Output the following text: ${text}` 
                    }] 
                },
                config: {
