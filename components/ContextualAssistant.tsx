...
const ContextualAssistant: React.FC<ContextualAssistantProps> = ({ listing, activeStep, appLanguage }) => {
    ...
    const handleGenerate = async (prompt: string) => {
        ...
        setResponse('');
        try {
            const systemInstruction = `You are a high-fidelity real estate assistant. Provide direct, unfiltered, and literal responses. ${appLanguage !== 'English' ? `Please provide your entire response in ${appLanguage}.` : ''}`;
